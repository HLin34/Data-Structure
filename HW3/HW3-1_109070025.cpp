...
int main()
{
    ...
    for (int i = 0; i < 6; i++)
        chain.InsertFront(i);
    cout << " The original Chain: " << chain;
    //cout << chain;
    chain.Delete(2);
    chain.InsertFront(10);
    cout <<" Delete the 2th position (start from 0 ) and InsertFront(10): "<< chain;
    Chain<int> newChain = chain.DivideMiddle();
    cout << " The new Chain after DividMiddle: "<< newChain;
    chain.InsertFront(6);
    cout << " The original Chain InsertFront(6): " << chain;
    chain.Merge(newChain);
    cout << " The original Chain merge with newChain: "<< chain;
    chain.DeleteFront();
    cout << " The Chain after DeleteFront: "<< chain;
    chain.DeleteBack();
    cout << " The Chain after DeleteBack: "<< chain;
    chain.Set(2, 5);
    cout << " The Chain Set(2,5), change the quality of position 2 to 5: "<< chain;
    cout << " Get the quality of position 3 use Get(3): "<< chain.Get(3) << endl;
    chain.Insert(4, 9);
    cout << " Insert 9 to the position 4: "<< chain;
    cout << " The size of the Chain: " << chain.Size() ;
    /*chain.DeleteOdd();
    cout << " DeleteOdd of the Chain: " << chain;*/
    cout << endl;
