...
int main()
{
    ...
    cout << endl;
    cout << "gl.Components: " << endl; g1.Components();
    cout << "g1.DfnLow from 3: " << endl; g1.DfnLow(3);
    cout << endl; g2.Setup2();
    cout << "g1.BFS(0): "; g2.BFS(0);
    cout << "g1.BFS(3): "; g2.BFS(3);
    cout << "g2.BFS(7): "; g2.BFS(7);
    cout << "g2.DFS(0): "; g2.DFS(0);
    cout << "g2.DFS(3): "; g2.DFS(3);
    cout << "g2.DFS(7): "; g2.DFS(7);
    cout << endl;
    cout << "g2.Components: " << endl; g2.Components();
    cout << "g2.DfnLow from 3: " << endl; g2.DfnLow(3);
    cout << endl; g3.Setup3();
    ...
    cout << endl;
    cout << "g3.Components: " << endl; g3.Components();
    cout << "g3.DfnLow from 3: " << endl; g3.DfnLow(3);
    cout << endl;
}
